...
<header class="max-w-lg mx-auto">
    <a href="#">
        <h1 class="text-4xl font-bold text-white text-center">{{ $title }} Register</h1>
    </a>
</header>
...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt-2">Sign in to your account <a href="/login" class="txt-purple-300 font-bold">here.</a></p> 
    </section>

    <section class="mt-10">
        <form action="/store" method="POST" class="flex flex-col">

            {{-- Cross site forgery attack, for unauthorized activities --}}
            @csrf
            ...
            <button
                class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover hover:shadow-xl transition duration-200"
