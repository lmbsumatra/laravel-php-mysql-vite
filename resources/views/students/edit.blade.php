...
<header class="max-w-lg mx-auto">
    <a href="#">
        <h1 class="text-4xl font-bold text-white text-center">Update Student: {{ $student->first_name }}
...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    ...
    <section class="mt-10">
        ...
        <form action="/student/{{ $student->id }}" method="POST">
            ...
            <button
                class="w-full mt-2 bg-red-600 hover:bg-red-700 text-white font-bold py-2 rounded shadow-lg hover hover:shadow-xl transition duration-200"
                type="submit">Delete
            </button>
        </form>
